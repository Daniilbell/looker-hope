# The name of this view in Looker is "Operational Payments Tasks Queue"
view: operational_payments_tasks_queue {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: hope.operational_payments_tasks_queue ;;
  drill_fields: [id]
