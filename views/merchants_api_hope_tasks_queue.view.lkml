# The name of this view in Looker is "Merchants API Hope Tasks Queue"
view: merchants_api_hope_tasks_queue {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: hope.merchants_api_hope_tasks_queue ;;
  drill_fields: [id]
